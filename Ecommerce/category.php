        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9">
                    <div class="box">
                        <h1>Pâtisserie</h1>
                        <p>Découvrez ici toutes les pâtisseries que notre site peut vous vendre !</p>
                    </div>

                    <div class="box info-bar">
                        <div class="row">
                            <div class="col-sm-12 col-md-4 products-showing">
                                Montrer <strong>?? <!-- Php --> </strong> de <strong>?? <!-- Php --></strong> produits
                            </div>
                                    ...
                                    <form class="form-inline">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="products-number">
                                                <strong>Montrer</strong>  <a href="#" class="btn btn-default btn-sm btn-primary">12</a>  <a href="#" class="btn btn-default btn-sm">24</a>  <a href="#" class="btn btn-default btn-sm">Tout</a>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <div class="products-sort-by">
                                                ...
                                                <select name="sort-by" class="form-control">
                                                    <option>Prix</option>
                                                    <option>Noms</option>
                                                    <option>Produits avec remise</option>
                                                </select>
                                            </div>
                                        </div>
                                    </form>
                    ...
                    <div class="pages">
                        ...
                        <p class="loadMore">
                            <a href="#" class="btn btn-primary btn-lg"><i class="fa fa-chevron-down"></i> Chargez plus de produits</a>
                        </p>
