            ...
            <div class="container">
                ...
                <div class="col-md-9" id="wishlist">
                    ...
                    <div class="box">
                        ...
                        <p class="lead">Ici sont regroupés tous les articles que vous avez aimé.</p>
                    </div>
                    <div class="row products">
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <a href="detail.phpphp" class="invisible">
                                    <img src="img/product1.jpg" alt="" class="img-responsive">
                                </a>
                                <div class="text">
                                    <h3><a href="detail.phpphp">Fur coat</a></h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                        <a href="detail.phpphp" class="btn btn-default">View detail</a>
                                        <a href="basket.phpphp" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                    </p>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.phpphp">White Blouse Armani</a></h3>
                                    <p class="price"><del>$280</del> $143.00</p>
                                    <p class="buttons">
                                        <a href="detail.phpphp" class="btn btn-default">View detail</a>
                                        <a href="basket.phpphp" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
